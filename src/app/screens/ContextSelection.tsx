...
export default function ContextSelection() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50 to-amber-50 p-6 pb-32 overflow-y-auto">
        ...
        <div className="mb-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-3xl text-purple-600">{temperature}°C</span>
            </div>
            <input
              type="range"
              min="0"
        ...
        <div className="fixed bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-white to-transparent">
          <div className="w-full max-w-md mx-auto">
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full text-lg shadow-xl hover:shadow-2xl transition-all flex items-center justify-center gap-2"
            >
              Continue
